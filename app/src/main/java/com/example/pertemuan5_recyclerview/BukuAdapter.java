...
public class BukuAdapter extends
        RecyclerView.Adapter<BukuAdapter.BukuViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public BukuAdapter(Context ct, String s1[], String s2[],
                       String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_buku,
                parent, false);
        return new BukuViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull
                                         BukuAdapter.BukuViewHolder holder, int position) {
    ...
    public class BukuViewHolder extends
